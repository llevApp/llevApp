            ...
            <Box style={styles.mainBox} >
                ...
                {tripsArray?.length > 0 ? 
                    (<><FlatList data={tripsArray.slice(tripsArray.length-4,tripsArray.length).reverse()} 
                        renderItem={({item}) => 
                            <Box borderWidth="0.4"  borderColor={item?.recentText > 5 ?  "#60d394":"#f68080"} _dark={{borderColor: "gray.600"} } background="white"  pl="4" pr="5" py="6" w = "100%" marginTop={1} h = "105" borderRadius={10}>
