...
useEffect( ()=>{
 if(isOpen){
  ...
  fetch('http://10.72.112.243:10000/api-llevapp/driver/new-trip', {
  method: 'POST',
  headers: {
      ...
      <View style={styles.container}>
        ...
        <Actionsheet.Content justifyContent="center">
          ...
          <Text style={styles.H1}>Gracias por usar LlevApp !</Text>
            ...
            <Actionsheet.Item style={styles.textContainer}>
              <HStack >
              <VStack >
                  <Avatar bg="transparent" mr="4" Avatar size="lg" source={{
            ...
            <VStack style={styles.textContainer}>
              <Button style={styles.button} onPress={toHome}>
